...
namespace VrBook.Modules.Identity.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260709222714_OpsM2_TenantsAddIsE2eColumn")]
    partial class OpsM2_TenantsAddIsE2eColumn
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("VrBook.Modules.Identity.Domain.MigrationAuditEntry", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("MigrationName", "ExecutedAt")
            ...
            modelBuilder.Entity("VrBook.Modules.Identity.Domain.Tenant", b =>
                {
                    ...
                    b.Property<bool?>("is_e2e")
                        .HasColumnType("boolean")
                        .HasColumnName("is_e2e");
            ...
            modelBuilder.Entity("VrBook.Modules.Identity.Domain.User", b =>
                {
                    ...
                    b.Property<DateTimeOffset?>("PreSeededAt")
                        .HasColumnType("timestamp with time zone")
                        .HasColumnName("pre_seeded_at");
            ...
            modelBuilder.Entity("VrBook.Modules.Identity.Domain.UserIdentity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
