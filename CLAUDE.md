...
- **OPS.M.22 (2026-07-07 plan committed)** — Admin pre-seed slice; plan at [`docs/OPS_M_22_ADMIN_PRESEED_PLAN.md`](docs/OPS_M_22_ADMIN_PRESEED_PLAN.md). 8 sub-commits, 2-session budget. Ships operator surface for pre-creating `identity.users` rows before first admin sign-in, closing the "sign-in-first + manual promote via SQL" shim used through 2026-07-08. Owner-locked answers in §7. Ready to execute.
