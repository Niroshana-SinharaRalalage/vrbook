...
| [0004](./0004-sendgrid-transactional-email.md) | SendGrid for Transactional Email | Accepted | Mature template editor and deliverability tooling, wrapped in an `INotificationSender` abstraction to keep the provider swappable. |
